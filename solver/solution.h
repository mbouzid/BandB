...
class Solution
{
    ...
    protected:
        ...
        static int insertBest(int16_t & t, std::vector<uint16_t> & orders, uint16_t & profit, core::heuristic::ratio hRatio, const Instance * instance, std::vector<uint16_t> & sequence);
        static void switchRatio(int16_t & t, std::map<uint16_t, double> & ratio, std::vector <uint16_t> & orders, core::heuristic::ratio hRatio, const Instance * instance);
